        ...
        <div className="space-y-0">
          {[
            ...
            },
            {
              ...
              title: 'Specialist',
              company: 'Apple',
              detail: 'Consultative sales and customer support across the Apple product range, with a focus on genuine, needs-based conversations.',
            },
          ].map((role, i) => (
            <motion.div
              key={i}
            ...
            >
              ...
              <div>
                <h3 className="font-medium text-[var(--foreground)]">{role.title}</h3>
                <p className="text-sm text-[var(--foreground-muted)]">{role.company}</p>
